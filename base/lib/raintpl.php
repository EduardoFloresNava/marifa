...
class Base_Lib_RainTPL {
	 ...
	 */
	protected $cache_id = NULL;	// identify only one cache
	 ...
	 * @param mixed $cache_id Cache identify number
	 ...
	 *
	 * @param mixed $setting Setting property
	 ...
	 * @return bool TRUE if the template has changed
	 */
	 ...
	 * @param string $tpl_basename Template basename
	 * @param string $tpl_basedir  Template basedir
	 * @param string $tpl_filename Template filename
	 * @param string $cache_dir    Cache directory
	 * @param string $compiled_filename Compile filename
	 * @access protected
	 */
	...
	/**
	 * Compile template
	 * @param mixed $template_code Template Code
	 * @param mixed $tpl_basedir Template basedir
	 * @access protected
	 */
	 ...
	 * @param mixed $php_left_delimiter
	 * @param mixed $php_right_delimiter
	 * @param mixed $loop_level = NULL
	 * @param mixed $echo = NULL
	 */
	...
	protected function printDebug(RainTpl_Exception $e)
	{
		...
		if ($e instanceof RainTpl_SyntaxException)
		{
			...
			if ($e->getTemplateLine() != NULL && $e->getTag() != NULL)
			{
