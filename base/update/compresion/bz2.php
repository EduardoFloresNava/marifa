...
/**
 * Compresor Tar.BZ2 basado en Pear_Archive
 *
 ...
 * @package    Marifa\Base
 */
class Base_Update_Compresion_BZ2 extends Update_Compresion_Compresion {
	...
	{
		$pt = new Update_Compresion_Pear_Tar($file, 'bz2');
	...
	{
		$pt = new Update_Compresion_Pear_Tar($path, 'bz2');
