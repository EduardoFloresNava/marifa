...
{if="$is_locked_for_me"}<div class="alert alert-danger"><b>!Alerta!</b> Si el sitio entra en modo mantenimiento no podrás acceder a él. Recomendamos agregar tu IP: <code>{function="get_ip_addr()"}</code></div>{/if}
