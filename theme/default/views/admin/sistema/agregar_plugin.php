<ul class="breadcrumb">
    ...
    <li><a href="{#SITE_URL#}/admin/sistema/plugins">{@Plugins@}</a> <span class="divider">/</span></li>
...
<form method="POST" enctype="multipart/form-data" class="form-horizontal" action="">
	...
	<div class="form-actions">
		<button type="submit" class="btn btn-large btn-primary">{@Importar@}</button> {@o@} <a href="{#SITE_URL#}/admin/sistema/plugins">{@Volver@}</a>
	</div>
</form>