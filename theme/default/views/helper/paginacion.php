...
<div class="pagination pagination-centered">
	<ul>
		{if="$paginacion.first != $actual && isset($paginacion.pages.0) && $paginacion.pages.0 > 1"}<li><a href="{function="sprintf($url, $paginacion.first)"}">«</a></li>{/if}
		...
		{if="$paginacion.last != $actual && $paginacion.last > 0 && count($paginacion.pages) > 0 && $paginacion.pages[count($paginacion.pages) - 1] < $paginacion.last"}<li><a href="{function="sprintf($url, $paginacion.last)"}">»</a></li>{/if}
	</ul>
</div>
{/if}