<ul class="breadcrumb">
    ...
    <li><a href="/moderar/denuncias/usuarios/">Usuarios</a> <span class="divider">/</span></li>
...
<form method="POST" class="form-horizontal" action="">
	...
	<div class="form-actions">
		<button type="submit" class="btn btn-large btn-primary">Enviar advertencia</button> o <a href="/moderar/denuncias/usuarios/">Volver</a>
	</div>
</form>