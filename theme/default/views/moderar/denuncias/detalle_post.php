<ul class="breadcrumb">
    ...
    <li><a href="/moderar/denuncias/posts/">Posts</a> <span class="divider">/</span></li>
    <li class="active">Detalles</li>
</ul>
<div class="header clearfix">
	<h2 class="pull-left">Detalles de la denuncia #{$denuncia.id}</h2>
	<div class="pull-right btn-group">
		<a href="/moderar/denuncias/posts/" class="btn">Volver</a>
	</div>
</div>
<table class="table table-bordered">
	...
	<tr>
		<th>Post</th>
		<td><a href="/post/index/{$post.id}">{$post.titulo}</a></td>
	</tr>
	<tr>
		<th>Fecha</th>
