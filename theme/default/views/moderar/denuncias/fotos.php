		...
		<tr>
			...
			<td style="text-align: center;">
				<div class="btn-group">
					...
					<a href="{#SITE_URL#}/foto/{$value.foto.categoria.seo}/{$value.foto_id}/{$value.foto.titulo|Texto::make_seo}" class="btn btn-mini btn-info show-tooltip" title="Ver foto"><i class="icon-white icon-eye-open"></i></a>
