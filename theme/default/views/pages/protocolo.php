<div class="text-justify">
	...
	<ul>
		...
		<li>Material que la administración de {$nombre} encuentre no conveniente.</li>
	</ul>
	...
	<ul>
		...
		<li>Hagan a través de cualquier medio (Mensaje personal, Comunidad, Tema, Respuesta, Comentario o Post) promoción de sitios y/o productos ajenos a {$nombre} y/o posts propios del usuario.(SPAM).</li>
	...
	<h2 class="title">RACISMO, XENOFOBIA, PEDOFILIA, VIOLENCIA no están permitidos en {$nombre}</h2>
