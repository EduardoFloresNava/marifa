<div class="text-justify">
	...
	<p>En forma previa a la utilización de cualquier servicio o contenido ofrecido en {$nombre}, debe leerse completa y atentamente este documento.</p>
	<p>Las presentes Condiciones Generales constituyen las normas y reglas dispuestas por {$nombre}, relativas a todos los servicios existentes actualmente o que resulten incluidos en el futuro dentro del sitio "{#SITE_URL|parse_url:PHP_URL_HOST#}" (el Sitio). Dichos servicios si bien pueden ser gratuitos, no son de libre utilización, sino que están sujetos a un conjunto de pautas que regulan su uso. El aprovechamiento que un individuo haga de los servicios incluidos en el Sitio, sólo se considerará lícito y autorizado cuando lo sea en cumplimiento de las obligaciones impuestas, con los límites y alcances aquí delineados, así como los que surjan de disposiciones complementarias o accesorias, y/o de las diferentes normativas legales de orden nacional e internacional cuya aplicación corresponda.</p>
	<p>{$nombre} podrá en cualquier momento y sin necesidad de previo aviso modificar estas Condiciones Generales. Tales modificaciones serán operativas a partir de su fijación en el sitio "{#SITE_URL|parse_url:PHP_URL_HOST#}". Los usuarios deberán mantenerse actualizados en cuanto al los términos aquí incluidos ingresando en forma periódica al apartado de legales de {$nombre}.</p>

	<ol>
		<li>
			<strong>La aceptación por parte de los Usuarios.</strong>
			<p>{$nombre}, se reserva el derecho a exigir que cada usuario, acepte y cumpla los términos aquí expresados como condición previa y necesaria para el acceso, y utilización de los servicios y/o contenidos brindados por el Sitio.</p>
		...
		<li>
			...
			<p>El usuario dispondrá, una vez registrado, de un nombre de usuario y una contraseña que le permitirá el acceso personalizado, confidencial y seguro a su cuenta personal dentro del Sitio. Los servicios sujetos a registración han sido concebidos para el uso personal del usuario requirente, por tanto el nombre de usuario y la contraseña de acceso concedidos por {$nombre} solo podrán ser usados por este, estando prohibida su utilización por otra persona distinta al mismo. El usuario registrado asumirá la obligación de guarda y custodia de su nombre de usuario y contraseña de acceso, debiendo informar inmediatamente a {$nombre} cuando los mismos hubieren perdido su estado de confidencialidad, y/o cuando sean objeto de uso por un tercero.</p>
			<p>Será también responsabilidad de cada usuario mantener actualizada su información personal asentada en el registro conforme resulte necesario, debiendo comunicar a {$nombre} toda vez que se produzcan cambios en relación a la misma.</p>
			<p>{$nombre} podrá rechazar cualquier solicitud de registración o, cancelar una registración previamente aceptada, sin que tal decisión deba ser justificada, y sin que ello genere derecho alguno en beneficio del Usuario.</p>
			<p>{$nombre} utilizará la información suministrada por el usuario exclusivamente con el objeto expuesto, y en todo momento velará por el razonable resguardo a la intimidad y confidencialidad de las comunicaciones del usuario, pero atento que {$nombre} hace uso de sistemas tecnológicos que bajo ciertas condiciones pueden resultar falibles, se pone en conocimiento de los usuarios que {$nombre} no garantiza la inviolabilidad de sus sistemas, motivo por el cual los usuarios deberán tomar en consideración esta circunstancia al momento de decidir su registración.</p>
			<p>En todos los casos, y de acuerdo con la <a href="/pages/privacidad/">Política de Privacidad</a> sostenida por {$nombre}, la información de carácter personal suministrada por los Usuarios será objeto de adecuado tratamiento y preservación, en resguardo de la privacidad de la misma. Sin embargo, los servicios de {$nombre} fueron diseñados entre otros fines para permitir que los usuarios accedan a ciertos datos (no sensibles) de otros usuarios permitiendo la interacción entre los mismos dentro de un esquema de red social. Por consiguiente, haciendo entrega de cualquier información personal distinta de su nombre, el usuario renuncia a cualquier expectativa de privacidad que posea con respecto al uso de esa información personal proporcionada dentro del sitio. Los usuarios que no deseen que su fotografía o imagen, página web, mensajero, ciudad de residencia, nacionalidad, o descripción personal ingresadas en el Sitio, puedan ser brindadas al público no deberán registrarse en {$nombre}.</p>
		</li>
		<li>
			<strong>Notificaciones y comunicaciones</strong>
			<p>A los fines que los usuarios puedan tomar contacto con {$nombre}, se considerarán válidas las comunicaciones dirigidas a través del formulario de contacto:</p>
			<p>Las notificaciones y comunicaciones cursadas por {$nombre} a la casilla de correo electrónico que surja como dirección de correo del usuario o remitente se considerarán eficaces y plenamente válidas. Asimismo se considerarán eficaces las comunicaciones que consistan en avisos y mensajes insertos en el sitio, o que se envíen durante la prestación de un servicio, que tengan por finalidad informar a los usuarios sobre determinada circunstancia.</p>
		</li>
		<li>
		...
		<li>
			...
			<ol>
				<li>
					...
					<ol style="list-style-type: lower-alpha">
						...
						<li>
							...
							<p>Así los links a diversos archivos que los usuarios incorporan en los post publicados en {$nombre} permiten invocar a una página web determinada, o a una posición determinada en una página web, pero en todos los casos los links siempre harán referencia a paginas web titularidad de terceros y ajenas al control de {$nombre}.</p>
				...
				<li>
					...
					<p>Otro de los servicios brindados por {$nombre}, reservado sólo a usuarios registrados, es la posibilidad de incorporar comentarios en forma de mensajes sobre un post de otro usuario, de tal forma que permita un intercambio de opiniones o aportes sobre el post que viene a comentar.</p>
				</li>
				<li>
					<strong>Del contacto entre usuarios</strong>
					<p>Adicionalmente {$nombre} brinda la posibilidad a los usuarios de conocer y establecer una comunicación directa con otros usuarios, estableciendo un sistema de contacto mediante sesiones de chat, o a través de la información por ellos brindada para ser incorporada en su perfil.</p>
				</li>
				<li>
		...
		<li>
			...
			<ol>
				<li>
					...
					<p>{$nombre} se reserva todas las facultades de control y dirección del Sitio, en particular de los servicios, contenidos y comunicaciones habidos dentro del mismo. Podrá en consecuencia {$nombre}, introducir todos los cambios y modificaciones que estime convenientes a su solo criterio, podrá agregar, alterar, sustituir o suprimir cualquiera de los servicios o contenidos en todo momento.</p>
					<p>En especial {$nombre} se reserva la facultad de controlar, editar, suprimir parcial o totalmente, cualquier post o comentario fijado por un usuario. Dicha facultad reposa en las facultades de dirección que posee {$nombre} en cuanto titular del Sitio, y su ejercicio no estará supeditado a justificación o causa alguna, quedando en todos los casos dicho ejercicio reservado a la discreción y voluntad de {$nombre}. Sin perjuicio de ello y al solo efecto de servir de guía orientativa para los usuarios, {$nombre} podrá establecer una serie de recomendaciones sobre los contenidos aceptados y aquellos que no lo fueren en relación a los posts y comentarios. Esta guía será accesible a los usuarios desde el propio Sitio y se la mencionará como "protocolo" o bajo alguna otra designación similar.</p>
				</li>
				<li>
					<strong>Responsabilidades en relación a los servicios prestados:</strong>
					<p>Cada usuario será exclusivo responsable por las manifestaciones que vierta o las acciones que lleve adelante dentro del marco del sitio. Sin embargo cuando {$nombre} reciba a través de su mecanismo de recepción de denuncias, la manifestación de una persona, que hubiere sufrido en forma injustificada un menoscabo en cualquiera de sus derechos, tomará en forma inmediata las medidas necesarias para evitar la continuación de la situación perjudicial, y pondrá en conocimiento de las autoridades competentes los acontecimientos del caso.</p>
			...
			<ol>
				<li>
					...
					<ol>
						...
						<li>Tenga por objeto vulnerar la seguridad, y o normal funcionamiento de los sistemas informáticos de {$nombre} o de terceros.</li>
				...
				<li>
					...
					<p>Sin perjuicio de las acciones legales nacidas en cabeza de {$nombre} o terceros, cuando el uso de los servicios, llevado adelante por parte de un usuario pueda ser reputado por {$nombre} como USO PROHIBIDO, {$nombre} tomará las medidas que considere convenientes según su exclusivo criterio, pudiendo suspender o impedir el acceso a los servicios o contenidos a aquellos usuarios incursos en el uso prohibido de los mismos, y sin que para ello deba mediar comunicación previa alguna.</p>
				</li>
			</ol>
		</li>
		<li>
			...
			<ol>
				<li>
					...
					<p>En uso de los servicios ofrecidos en el Sitio, el usuario puede tener acceso a contenidos provistos por otros usuarios o terceros. {$nombre} realiza sus mejores esfuerzos para controlar el material que le es suministrado, sin embargo, el usuario acepta que eventualmente podrá ser expuesto a contenido de terceros que sea falso, ofensivo, indecente o de otra manera inaceptable. Bajo ninguna circunstancia podrá responsabilizar a {$nombre} por tal circunstancia.</p>
				</li>
				<li>
					<strong>9.2. Material titularidad de {$nombre}</strong>
					<p>Todo el material existente en el sitio, que no corresponda a un usuario u otro tercero, constituye propiedad exclusiva de {$nombre}. A título meramente enunciativo, se entenderán incluidos las imágenes, fotografías, diseños, gráficos, sonidos, compilaciones de datos, marcas, nombres, títulos, designaciones, signos distintivos, y todo otro material accesible a través del sitio.</p>
					<p>La titularidad del conjunto o selección de links incorporados por los usuarios al Sitio, corresponderá a {$nombre} en calidad de propiedad intelectual, en tanto obra de clasificación y compilación. Dicha propiedad esta constituida no por los vínculos o links considerados en forma individual, sino por la selección del conjunto de links. En ese orden los usuarios ceden y transfieren irrevocablemente a {$nombre} todos los derechos que pudieran corresponderles sobre la selección de links que cada uno de ello individualmente hubiere realizado.</p>
					<p>{$nombre} se reserva todos los derechos sobre el mencionado material, no cede ni transfiere a favor del usuario ningún derecho sobre su propiedad intelectual o la de terceros. En consecuencia, su reproducción, distribución, y/o modificación deberá ser expresamente autorizada por parte de {$nombre}, so pena de considerarse una actividad ilícita violatoria de los derechos de propiedad intelectual de {$nombre}.</p>
					<p>Los usuarios del sitio sólo contarán con autorización para la utilización del material propiedad de {$nombre}, cuando las finalidades de tal utilización sean aquellas específicamente previstas por {$nombre}.</p>
		...
		<li>
			...
			<p>Correspondientemente con el carácter gratuito de los servicios brindados, {$nombre} no garantiza la plena operatividad del sitio y el acceso a los servicios y contenidos del mismo. En ningún caso {$nombre} responderá por la operatividad, eficacia y seguridad de los servicios y contenidos puestos a disposición de los usuarios.</p>
			<p>{$nombre} no garantiza la conservación, integridad ni indemnidad de los post, mensajes o comentarios fijados por los usuarios.</p>
		</li>
		<li>
			<strong>LINKS hacia {$nombre}</strong>
			<p>El establecimiento de cualquier link, hipervínculo o enlace, entre una página web ajena al sitio "{#SITE_URL|parse_url:PHP_URL_HOST#}" y cualquier página de este último solo podrá realizarse con expresa autorización por parte de {$nombre}.</p>
			<p>En ningún caso {$nombre} será responsable por los contenidos o manifestaciones existentes en las páginas web desde donde se establezcan los hipervínculos hacia el sitio de {$nombre}. El hecho que exista un link entre una página web y el sitio de {$nombre} no implica que {$nombre} tenga conocimiento de ello, o que {$nombre} mantenga relación alguna con los titulares de la página web desde donde se establece el enlace.</p>
			<p>{$nombre}, se reserva el derecho a solicitar la remoción o eliminación de cualquier enlace desde una página web ajena al Sitio, en cualquier momento, sin expresión de causa, y sin que sea necesario preaviso alguno. El responsable de la página web desde la cual se efectuare el enlace tendrá un plazo de 48hs. contados a partir del pedido de {$nombre} para proceder a la remoción o eliminación del mismo.</p>
		</li>
		<li>
			...
			<ol>
				<li>
					...
					<p>Los hipervínculos o enlaces a páginas web de terceros provistos por {$nombre}, tienen por finalidad mejorar la experiencia de navegación del usuario por el sitio {$nombre}, poniendo a su disposición canales de acceso a otros sitios.</p>
				</li>
				<li>
				...
				<li>
					...
					<p>La responsabilidad por los servicios o contenidos en los sitios enlazados corresponderá exclusivamente a los titulares de dichos sitios. Bajo ningún supuesto {$nombre} será responsable por las irregularidades, ilicitudes o infracciones que en dichos sitios se registren, no respondiendo en tal sentido por los daños que pudieren experimentar los usuarios o terceros a partir de los contenidos allí publicados.</p>
					<p>El acceso y utilización de páginas web enlazadas desde el sitio de {$nombre} será exclusiva responsabilidad del usuario, quien deberá tomar todas las medidas de precaución necesarias de acuerdo al tipo de servicio, o contenido al que acceda.</p>
					<p>El usuario que considere inadecuada una página vinculada desde el Sitio, podrá elevar su queja o recomendación a través del mecanismo de denuncias puesto a disposición de los usuarios por parte de {$nombre}.</p>
				</li>
			</ol>
		<li>
			<strong>Finalización del Servicio</strong>
			<p>{$nombre} podrá a su sola discreción suspender temporalmente o desactivar definitivamente la cuenta de un usuario, sin que medie previa notificación al mismo, y sin que sea necesaria la invocación de causa alguna, procediéndose en tal caso a la eliminación de toda la información relacionada con la cuenta.</p>
		</li>
		<li>
