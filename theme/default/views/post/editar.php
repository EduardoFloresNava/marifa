		...
		<form method="POST" class="form-horizontal" action="">
			...
			<div class="control-group{if="$error_contenido"} error{/if}">
				...
				<div class="controls">
					...
					<textarea name="contenido" id="contenido" class="span10" data-preview="/foto/preview">{$contenido}</textarea>
			...
			<div class="form-actions">
				<button type="submit" class="btn btn-large btn-primary">Actualizar</button> o <a href="/post/index/{$post}/">Volver</a>
			</div>
		</form>
	</div>
</div>