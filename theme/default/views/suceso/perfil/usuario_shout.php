<div class="suceso clearfix">
	...
	<div class="links">
		<div class="btn-group pull-right">
			...
			<a class="btn active" href="/perfil/votar_publicacion/{$suceso.usuario.nick}/{$suceso.shout.id}/0"><i class="icon icon-thumbs-up"></i> {$suceso.shout.votos}</a>
				{else}
			<a class="btn" href="/perfil/votar_publicacion/{$suceso.usuario.nick}/{$suceso.shout.id}/1"><i class="icon icon-thumbs-up"></i> {$suceso.shout.votos}</a>
				{/if}
			{else}
			...
			<a class="btn active" href="/perfil/favorito_publicacion/{$suceso.usuario.nick}/{$suceso.shout.id}/0"><i class="icon icon-star"></i> {$suceso.shout.favoritos}</a>
				{else}
			<a class="btn" href="/perfil/favorito_publicacion/{$suceso.usuario.nick}/{$suceso.shout.id}/1"><i class="icon icon-star"></i> {$suceso.shout.favoritos}</a>
				{/if}
			{else}
