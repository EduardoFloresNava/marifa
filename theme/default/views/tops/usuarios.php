	...
	<div class="span10">
		<div class="row-fluid">
			<div class="span6">
				...
				<ol>
					{loop="$puntos"}
					<li><a href="/perfil/index/{$value.nick}">{$value.nick}<span class="badge pull-right">{$value.puntos}</span></a></li>
					{/loop}
				</ol>
				{/if}
			</div>
			<div class="span6">
				...
				<ol>
					{loop="$seguidores"}
					<li><a href="/perfil/index/{$value.nick}">{$value.nick}<span class="badge pull-right">{$value.seguidores}</span></a></li>
					{/loop}
				</ol>
				{/if}
			</div>
